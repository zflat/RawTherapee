...
//  EvFixedch=235,   -- can be reused --
    ...
    EvLskal = 441,
    EvlocallabEnabled = 442,
    EvlocallablocY = 443,
    EvlocallablocX = 444,
    EvlocallabCenter = 445,
    EvlocallabDegree = 446,
    Evlocallablightness = 447,
    Evlocallabcontrast = 448,
    Evlocallabchroma = 449,
    Evlocallabtransit = 450,
    Evlocallabavoid = 451,
    EvlocallablocYT = 452,
    EvlocallablocXL = 453,
    EvlocallabSmet = 454,
    Evlocallabinvers = 455,
    Evlocallabradius = 456,
