...
public:
    ...
    void MSR(float** luminance, const float * const *originalLuminance, const float * const *exLuminance,  const LUTf &mapcurve, const bool mapcontlutili, const int width, const int height, const RetinexParams &deh, const RetinextransmissionCurve &dehatransmissionCurve, float &minCD, float &maxCD, float &mini, float &maxi, float &Tmean, float &Tsigma, float &Tmin, float &Tmax);
