...
public :
    ...
    virtual void localChanged (int **datasp, std::string datastr, std::string ll_str, int sp, int maxdat) {}
    virtual void localretChanged (int **datasp, std::string datastr, std::string ll_str, int sp, int maxdat) {}
