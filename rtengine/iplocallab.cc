...
/*
        void ImProcFunctions::InverseSharp_Local(int sp, float **loctemp, int **dataspot, const struct local_params & lp, LabImage * original, LabImage * transformed, int cx, int cy)
