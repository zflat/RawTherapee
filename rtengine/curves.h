...
{
private:
    LUTf lutWavstyCurve;  // 0xffff range
    void Set(const Curve &pCurve);
...
public:
    ...
    float operator[](float index) const
    {
        return lutWavstyCurve[index];
    }
    operator bool (void) const
    {
        return lutWavstyCurve;
    }
};
...
{
private:
    LUTf lutWavsty2Curve;  // 0xffff range
    void Set(const Curve &pCurve);

public:
    float sum;

    virtual ~Wavsty2Curve() {};
    Wavsty2Curve();
    void Reset();
    void Set(const std::vector<double> &curvePoints);
    float getSum() const
    ...
    float operator[](float index) const
    {
        return lutWavsty2Curve[index];
    }
    operator bool (void) const
    {
        return lutWavsty2Curve;
    }
};
...
{
private:
    LUTf lutWavmerg2Curve;  // 0xffff range
    void Set(const Curve &pCurve);

public:
    float sum;

    virtual ~Wavmerg2Curve() {};
    Wavmerg2Curve();
    void Reset();
    void Set(const std::vector<double> &curvePoints);
    float getSum() const
    ...
    float operator[](float index) const
    {
        return lutWavmerg2Curve[index];
    }
    operator bool (void) const
    {
        return lutWavmerg2Curve;
    }
};
